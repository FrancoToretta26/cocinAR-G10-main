...
export const registro= async function(registro)
{
    ...
    try
    {
        let response = await fetch('http://192.168.77.197:9000/recetasApi/register',{ // Poner la IPV4 de cada uno.
            method: 'POST', // or 'PUT'
            headers: {
...
export const login= async function(login)
{
    ...
    try
    {
        let response = await fetch('http://192.168.77.197:9000/recetasApi/login',{ // Poner la IPV4 de cada uno.
            method: 'POST', // or 'PUT'
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json'
...
export const finalizarRegistro = async function(data)
{
    ...
    try
    {
        let response = await fetch('http://192.168.77.197:9000/recetasApi/register/endRegister',{ // Poner la IPV4 de cada uno.
            method: 'POST', // or 'PUT'
            headers: {
                Accept: 'application/json',
                'Content-Type': 'application/json'
